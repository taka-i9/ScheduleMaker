...
class RepresentationController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        if($request->representation_style == 'month') {
            ...
            $begin = new \DateTimeImmutable($view_from.' 00:00:00');
            $end = $begin->modify('+1 days');
        }
        $representation_data['schedule'] = self::getSchedule($begin->format('Y-m-d'), $end->format('Y-m-d'));
        return view('representationTop', ['representation_style' => $request->representation_style, 'representation_data' => $representation_data, 'view_from' => $view_from]);
    }
}
